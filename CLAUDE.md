...
Quatre scénarios A/B/C/D sur Pulsar 2.11.0 + un scénario V3 sur Pulsar 3.3.9, documentés dans `docs/`. **D** est la preuve minimale (unload suffit, pas besoin de restart). **V3** prouve que le bug survit à l'upgrade broker.
